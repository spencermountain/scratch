...
var color = _dereq_('spencer-color');

var colors = [].concat(color.combos.ken, color.combos.palmer, color.combos.roma, color.combos.dupont, color.combos.barrow);
...
w.line().dotted(true).width(2).color('lighter').set([[data.votes[0].date, 50], [data.votes[data.votes.length - 1].date, 50]]); // w.line()
//   .dotted(true)
//   .width(2)
//   .color('lighter')
//   .set([['march 7th 2019', 35], ['march 7th 2019', 90]])

w.text(['13 items', 'March 7th']).color('light').dx(-3).before('march 7th', 45);
data.council.forEach(function (person, p) {
  var line = w.line().straight().width(5);
  var sum = 50;
  ...
  line.set(votes); // line.set([[1, 20], [2, Math.random() * 100], [3, 22]])

  line.color(colors[p]);
  w.text(person.name).after(votes[votes.length - 1][0], sum).font(6).dy(-7).color(colors[p]);
});
w.y.fit(35, 95);
w.x.fit();
...
},{"./data/votes":2,"somehow":20,"spencer-color":44}],4:[function(_dereq_,module,exports){
...
},{"d3-path":4}],6:[function(_dereq_,module,exports){
(function (global){
...
},{"./_clip":12,"./axis/XAxis":15,"./axis/YAxis":16,"./methods":21,"./scales/Scale":23,"./scales/YScale":24,"./shapes/Annotation":26,"./shapes/Area":27,"./shapes/Arrow":28,"./shapes/Bar":29,"./shapes/Dot":30,"./shapes/Image":31,"./shapes/Line":32,"./shapes/MidArea":33,"./shapes/Now":34,"./shapes/Rect":35,"./shapes/Shape":36,"./shapes/Text":37,"./shapes/Title":38,"fit-aspect-ratio":6,"htm":7,"vhtml":45}],12:[function(_dereq_,module,exports){
...
},{"./_custom":17,"./_ticks":19,"spencer-color":44}],15:[function(_dereq_,module,exports){
...
},{"./_prettyNum":18,"spacetime":10}],18:[function(_dereq_,module,exports){
...
},{"spacetime":10}],23:[function(_dereq_,module,exports){
...
},{"./Text":37,"spencer-color":44}],27:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
...
},{"../parse":22,"./Shape":36,"d3-shape":5,"spencer-color":44}],28:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const d3Shape = _dereq_('d3-shape')
const Shape = _dereq_('./Shape')
...
},{"./Shape":36,"d3-shape":5,"spencer-color":44}],29:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
...
},{"../parse":22,"./Rect":35,"spencer-color":44}],30:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const Shape = _dereq_('./Shape')
...
},{"./Shape":36,"spencer-color":44}],31:[function(_dereq_,module,exports){
const Shape = _dereq_('./Shape')
const colors = _dereq_('spencer-color').colors
...
},{"./Shape":36,"spencer-color":44}],32:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const d3Shape = _dereq_('d3-shape')
const Shape = _dereq_('./Shape')
...
},{"./Shape":36,"d3-shape":5,"spencer-color":44}],33:[function(_dereq_,module,exports){
...
},{"../parse":22,"./Area":27,"./lib/parseInput":39,"d3-shape":5}],34:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
...
},{"./Line":32,"spencer-color":44}],35:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const Shape = _dereq_('./Shape')
...
},{"./Shape":36,"spencer-color":44}],36:[function(_dereq_,module,exports){
const d3Shape = _dereq_('d3-shape')
const colors = _dereq_('spencer-color').colors
const fns = _dereq_('../_fns')
const parseInput = _dereq_('./lib/parseInput')
...
},{"../_fns":13,"../parse":22,"./lib/parseInput":39,"d3-shape":5,"spencer-color":44}],37:[function(_dereq_,module,exports){
const Shape = _dereq_('./Shape')
const colors = _dereq_('spencer-color').colors
...
},{"./Shape":36,"spencer-color":44}],38:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const Text = _dereq_('./Text')
...
},{"./Text":37,"spencer-color":44}],39:[function(_dereq_,module,exports){
const { parseX, parseY } = _dereq_('../../parse')
...
},{"../_version":40,"./methods":43,"spacetime":1}],43:[function(_dereq_,module,exports){
